...
CREATE TABLE `db_user` (
  ...
  `traffic_enabled` bigint(20) NOT NULL DEFAULT '0',
  `last_use_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `last_get_gift_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `last_check_in_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `last_reset_pass_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
